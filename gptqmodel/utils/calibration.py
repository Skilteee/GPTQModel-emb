...
def prepare_calibration_dataset(
    ...
    if 'embed_inputs' in calibration_dataset[0]:
    ...
    def convert_batch_to_embedding(
            batch,
            model,
    ):
        """
    ...
    #
    # embedding_layer = qmodel.model.get_input_embeddings()

    # if embedding_layer.weight.device.type == "meta":
    #     embedding_layer.to("cuda")  # 或 quantize_config.device
    # new_calibration_dataset_batched = [
    #     convert_batch_to_embedding(
    #         batch,
    #         model=qmodel.model,
    #     )
    #     for batch in new_calibration_dataset_batched
